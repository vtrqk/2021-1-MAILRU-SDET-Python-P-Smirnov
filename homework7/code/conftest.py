...
def start_app(config):
    ...
    app_out = open('d:\\otch\\app_stdout.log', 'w')
    app_err = open('d:\\otch\\app_stderr.log', 'w')
...
def start_stub(config):
    ...
    stub_out = open('d:\\otch\\stub_stdout.log', 'w')
    stub_err = open('d:\\otch\\stub_stderr.log', 'w')
...
def stop_stub(config):
    config.stub_proc.send_signal(signal.CTRL_C_EVENT)
